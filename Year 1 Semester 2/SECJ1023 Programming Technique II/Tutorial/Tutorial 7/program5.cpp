...
//! Determine the issue faced by this program.
//! Then, fix the issue by refactoring the program using inheritance.
...
public:
    ...
    void setPostCode(string _postCode) { postCode = _postCode; }
